...
class BlogDetails extends Component{
    ...
    render(){
        return(
            <>
            <section className="blog-details-hero set-bg" style={{ backgroundImage: `url("img/blog/blog-details/blog-details-hero.jpg")`}} data-setbg="img/blog/blog-details/blog-details-hero.jpg">
                    ...
                    <div className="row">
                        <div className="col-lg-10 offset-lg-1">
                            <div className="bd-hero-text">
                                ...
                                <ul>
                                    <li className="b-time"><i className="icon_clock_alt"></i> 15th April, 2019</li>
                                    ...
                                    <div className="single-comment-item first-comment">
                                        ...
                                        <div className="sc-text">
                                            ...
                                            <p>Neque porro qui squam est, qui dolorem ipsum quia dolor sit amet, consectetur,
                                                ...
                                                dolore magnam.</p>
                                            <a href="#" className="comment-btn">Like</a>
                                            <a href="#" className="comment-btn">Reply</a>
                                        </div>
                                    </div>
                                    <div className="single-comment-item reply-comment">
                                        ...
                                        <div className="sc-text">
                                            ...
                                            <p>Neque porro qui squam est, qui dolorem ipsum quia dolor sit amet, consectetur,
                                                adipisci velit, sed quia non numquam eius modi tempora. incidunt ut labore et
                                                dolore magnam.</p>
                                            <a href="#" className="comment-btn like-btn">Like</a>
                                            <a href="#" className="comment-btn reply-btn">Reply</a>
                                        </div>
                                    </div>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <div className="blog-item set-bg" style={{ backgroundImage: `url("img/blog/blog-1.jpg")`}} data-setbg="img/blog/blog-1.jpg">
                        ...
                        <div className="col-md-4">
                            <div className="blog-item set-bg" style={{ backgroundImage: `url("img/blog/blog-2.jpg")`}} data-setbg="img/blog/blog-2.jpg">
                                <div className="bi-text">
                        ...
                        <div className="col-md-4">
                            <div className="blog-item set-bg" style={{ backgroundImage: `url("img/blog/blog-3.jpg")`}} data-setbg="img/blog/blog-3.jpg">
                                <div className="bi-text">
